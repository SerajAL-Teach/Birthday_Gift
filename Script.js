...
function updateMusicSparkles(delta, now) {
  ...
  for (let i = activeSparkles.length - 1; i >= 0; i--) {
    ...
    const opacity = Math.sin(Math.min(life, 1) * Math.PI);
